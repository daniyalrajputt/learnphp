                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="f_name" class="form-control py-4" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="l_name" class="form-control py-4" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="email" class="form-control py-4" required
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="password" class="form-control py-4" required
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="small mb-1" for="inputConfirmPassword">Confirm
                                                        Password</label>
                                                    <input name="c_password" class="form-control py-4" required
